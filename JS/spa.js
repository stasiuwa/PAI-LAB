...
function pokazGalerie(){
    ...
    for(let i=1; i<10; i++){
        content += '<div class="slajd"><img src="../images/photos/obraz' + i + '.jpg" alt="Zdjęcie 1" /></div>';
    }
    return content + '</div>';
}
...
function pokazKontakt(){
    ...
    content += '<div id="kontakt"><p>Imie i nazwisko: KRzysztof Jarzyna ze szczecina</p>' +
        '<p>Telefon: 669399708</p>' +
        '<p>E-mail: Yayami_o_MATE@.pl</p></div>';
    return content;
}
